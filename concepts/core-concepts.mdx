...
If YES trades at `0.65`, NO is `0.35`. Buying NO at `0.35` is the mirror image of
selling YES at `0.65` — they are the same economic position.
...
<CardGroup cols={2}>
  ...
  <Card title="Placing orders" href="/trading-placing-orders">
    Limit vs market orders in practice.
  </Card>
