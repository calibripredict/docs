...
| Pay **one** fee per bridge to Calibri's treasury, only when Calibri's relayer calls it — at most 10 USDC and at most 20% of the amount | Move any other token, or ETH |
...
this Safe on Polygon by the module above and credited the same way, less a capped fee —
