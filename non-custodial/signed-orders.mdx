...
- **`3`** — sign the [SafeMessage](/api-reference/authentication), not the order
  ...
  you.
- **`0`** — sign the order with your wallet key. Set both fields to your wallet
  address.

Your type follows from what owns your Safe: a wallet you hold the key for
(`2`), a passkey (`3`), or no Safe at all (`0`) — so it is fixed by [how you set
your wallet up](/non-custodial/wallets#which-signature-type-your-wallet-gets).
The names below are the exchange contract's enum and mean the same as the
numbers:
